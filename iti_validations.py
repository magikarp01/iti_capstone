...
tqa_acts = ModelActs(model, tqa_mc)
tqa_acts.get_acts(N=200, id = "tqa_gpt2xl_200")
# tqa_acts.load_acts(id="tqa_gpt2xl_200")
...
tqa = -np.sort(-tqa_all_head_accs_np.reshape(tqa_acts.model.cfg.n_layers, tqa_acts.model.cfg.n_heads), axis = 1)
...
cfact_acts_iti.get_acts(N = 200, id = "iti_tqa_gpt2xl_200")
