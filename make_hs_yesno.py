...
prompt_3 = """Please generate 50 obvious, objective, common-knowledge true/false questions that a high schooler would learn in class about the topic prompted, as well as the correct response. These questions should be less like trivia questions (i.e. Is XYZ known as the Queen of Jazz?) and more like obvious facts (i.e. The central limit theorem states XYZ).
...
easy_questions.head()
# %%
easy_questions.to_csv("hs_qa.csv")
# %%
